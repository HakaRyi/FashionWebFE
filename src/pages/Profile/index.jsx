...
import styles from '@/features/profile/styles/Profile.module.scss';

const ProfilePage = ({ accountId }) => {
    const { account, expert, loading } = useProfile(accountId);
    ...
    const ActionButtons = (
        <>
            ...
            <button className={styles.iconBtn}>Settings</button>
        </>
    );
    ...
    return (
        ...
        >
            <ProfileTabs isExpert={!!expert} />
            <GalleryGrid posts={account?.posts} />
        </ProfileLayout>
    );
};
