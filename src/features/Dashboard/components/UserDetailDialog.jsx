      ...
      <div className={styles.modalContent} onClick={(e) => e.stopPropagation()}>
        ...
        <div className={styles.modalBody}>
          ...
          <div className={styles.infoGrid}>
            ...
            <div className={styles.infoItem}>
              <FaUser /> <span>Status:</span> 
              <b style={{ color: user.status === "Active" ? "#10b981" : "#ef4444" }}> {user.status}</b>
            </div>
            <div className={styles.infoItem}>
              <FaNewspaper /> <span>Posts:</span> <b>{user.postCount}</b>
            </div>
            <div className={styles.infoItem}>
              <FaUsers /> <span>Followers:</span> <b>{user.followerCount}</b>
            </div>
            <div className={styles.infoItem}>
              <FaUserPlus /> <span>Following:</span> <b>{user.followingCount}</b>
            </div>
          </div>
